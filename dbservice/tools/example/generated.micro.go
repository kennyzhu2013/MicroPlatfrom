...
import github_com_kennyzhu_goos_dbservice_tools_example_categories "github.com/kennyzhu/go-os/dbservice/tools/example/categories"
import _ "github.com/gogo/protobuf/types"
...
var _ = fmt.Errorf
var _ = math.Inf
var _ = github_com_kennyzhu_goos_dbservice_tools_example_categories.CategoryOptions{}
...
type ExampleService interface {
	...
	RandomCategory(ctx context.Context, in *RandomCategoryRequest, opts ...client.CallOption) (*github_com_kennyzhu_goos_dbservice_tools_example_categories.CategoryOptions, error)
...
func (c *exampleService) RandomCategory(ctx context.Context, in *RandomCategoryRequest, opts ...client.CallOption) (*github_com_kennyzhu_goos_dbservice_tools_example_categories.CategoryOptions, error) {
	req := c.c.NewRequest(c.name, "ExampleService.RandomCategory", in)
	out := new(github_com_kennyzhu_goos_dbservice_tools_example_categories.CategoryOptions)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ExampleServiceHandler interface {
	...
	RandomCategory(context.Context, *RandomCategoryRequest, *github_com_kennyzhu_goos_dbservice_tools_example_categories.CategoryOptions) error
...
func RegisterExampleServiceHandler(s server.Server, hdlr ExampleServiceHandler, opts ...server.HandlerOption) {
	type exampleService interface {
		...
		RandomCategory(ctx context.Context, in *RandomCategoryRequest, out *github_com_kennyzhu_goos_dbservice_tools_example_categories.CategoryOptions) error
...
func (h *exampleServiceHandler) RandomCategory(ctx context.Context, in *RandomCategoryRequest, out *github_com_kennyzhu_goos_dbservice_tools_example_categories.CategoryOptions) error {
