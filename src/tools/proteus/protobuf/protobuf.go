package protobuf // import "github.com/kennyzhu/go-os/tools/proteus/protobuf"
...
type Type interface {
	fmt.Stringer
	isType()
	SetSource(scanner2.Type)
	Source() scanner2.Type
	IsNullable() bool
}
...
func (n *Named) SetSource(t scanner2.Type) {
	n.Src = t
}

// Source returns the scanner source type for a given protobuf type
func (n *Named) Source() scanner2.Type {
	return n.Src
}
...
// SetSource sets the scanner type source for a given protobuf named type.
func (a *Alias) SetSource(t scanner2.Type) {
	a.Src = t
}

// Source returns the scanner source type for a given protobuf type
func (a *Alias) Source() scanner2.Type {
	return a.Src
}
...
func (b *Basic) SetSource(t scanner2.Type) {
	b.Src = t
}

// Source returns the scanner source type for a given protobuf basic type
func (b *Basic) Source() scanner2.Type {
	return b.Src
}
