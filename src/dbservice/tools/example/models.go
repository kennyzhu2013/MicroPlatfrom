...
//go:generate proteus -p github.com/kennyzhu/go-os/tools/proteus/example -f $GOPATH/src/github.com/kennyzhu/go-os/tools/proteus/example/protos
...
type Category struct {
	...
	Type    Type
	Color   Color
	Options categories2.CategoryOptions
}
...
//proteus:generate
func RandomCategory() categories2.CategoryOptions {
	return categories2.CategoryOptions{
